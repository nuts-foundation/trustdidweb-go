...
tdw := trustdidweb.NewTrustDIDWeb("did:tdw:{SCID}:example.com}", "ecdsa-jcs-2019")
signer, _ := tdw.NewSigner()
params, _ := tdw.NewParams([]crypto.Public{signer.Public()}, nil)
// create a DIDLog
...
- Validation of ecdsa-jcs-2019 keys generated by the [python implementation](https://github.com/bcgov/trustdidweb-py) see issue bcgov/trustdidweb-py#1
